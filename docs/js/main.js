...
/* harmony import */ var _components_slider_promo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/slider-promo */ "./src/js/components/slider-promo.js");
/* harmony import */ var _components_slider_clients__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/slider-clients */ "./src/js/components/slider-clients.js");
...
/* harmony import */ var _components_subscription__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/subscription */ "./src/js/components/subscription.js");
...
var Accordion = /*#__PURE__*/function () {
  function Accordion(el) {
    ...
    this.summary = el.querySelector('.faq-item__title'); // Store the <div class="content"> element

    this.content = el.querySelector('.faq-item__content'); // Store the animation object (so we can cancel it if needed)
...
dropdownElements.forEach(function (el) {
  var dropdownBtn = el.querySelector('.dropdown__btn');
  var dropdownContent = el.querySelector('.dropdown__content');
  dropdownBtn.addEventListener('click', function (evt) {
    ...
    if (!el.classList.contains('dropdown--open')) {
      ...
      dropdownContent.style.maxHeight = "".concat(dropdownContent.scrollHeight + 16, "px");
    } else {
...
/***/ "./src/js/components/slider-clients.js":
/*!*********************************************!*\
  !*** ./src/js/components/slider-clients.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/slider-promo.js":
/*!*******************************************!*\
  !*** ./src/js/components/slider-promo.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination]);
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".promo__slider", {
  slidesPerView: 'auto',
  pagination: {
...
/***/ "./src/js/components/subscription.js":
/*!*******************************************!*\
  !*** ./src/js/components/subscription.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var afterForm = function afterForm() {
  var subscription = document.querySelector('.subscription__wrapper');
  var subscriptionTitle = subscription.querySelector('.subscription__title');
  subscriptionTitle.textContent = "Отлично!";
  var subscriptionText = subscription.querySelector('.subscription__text');
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.subscription__form', rules, afterForm);
...
var validateForms = function validateForms(selector, rules, afterSend, config) {
  var _document;
  ...
  try {
    var _loop = function _loop() {
      ...
      validation.addField(item.ruleSelector, item.rules, item.config);
      document.querySelector(item.ruleSelector).addEventListener('input', function () {
        validation.revalidateField(item.ruleSelector).then(function (isValid) {});
      });
    };
